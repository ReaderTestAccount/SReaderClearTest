...
public abstract class Utils
{
	...
	// Renamed! According to name method should return width, but returns
	// BOOLEAN ????
	public static boolean willDrawSinglelineText(Paint textPaint, String text, int widthdisplay)
	{
		boolean res;
		Rect bounds = new Rect();
		textPaint.getTextBounds(text, 0, text.length(), bounds);
		int width = bounds.width();
		// Remove redundant return point.
