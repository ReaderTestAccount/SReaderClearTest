...
public class SaxPars extends DefaultHandler
{
	...
	public void characters(char[] ch, int start, int length) throws SAXException
	{
		...
		if (descript)
		{
			if (ElementName.equalsIgnoreCase("genre"))
				book.genres.add(new String(ch, start, length));
			
			if (ElementName.equalsIgnoreCase("first-name"))
				authors.setFirst_name(new String(ch, start, length));
			
			if (ElementName.equalsIgnoreCase("last-name"))
				authors.setLast_name(new String(ch, start, length));
			
			if (ElementName.equalsIgnoreCase("book-title"))
